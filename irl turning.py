...
data = np.load('/home/peter/GameFormer-Planner/nuplan/processed_data/us-pa-pittsburgh-hazelwood_fbaabcb5a93c560e.npz')
...
def polynomial_trajectory_sampler(current_state, target_state, obstacle_states, T=2.7):
    # 从起点状态到目标状态采样一条多项式轨迹
